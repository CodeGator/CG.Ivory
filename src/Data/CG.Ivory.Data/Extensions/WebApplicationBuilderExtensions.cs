...
public static class WebApplicationBuilderExtensions
{
    ...
    /// <summary>
    /// This method adds repositories and related services, for the data-access 
    /// layer.
    /// </summary>
        ...
        )
    {
        ...
        webApplicationBuilder.Services.AddScoped<ITodoRepository, TodoRepository>();
        ...
        webApplicationBuilder.Services.AddAutoMapper(cfg =>
        {
            ...
            cfg.CreateMap<TodoEntity, TodoModel>().ReverseMap();
        });
